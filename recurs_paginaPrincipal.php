...
<div id="PAGINA_MODIFICADA">
    <?php include_once __DIR__.'/controlador/controlador_slides.php'; ?>
    <div id="gridPaginaPrincipal">
        <?php include_once __DIR__.'/controlador/controlador_gridPagPrincipal.php'; ?>
    </div>
</div>
